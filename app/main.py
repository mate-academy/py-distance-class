...
class Distance:
    ...
    def __eq__(self, other_distance: float | Distance) -> bool:
        if isinstance(other_distance, Distance):
            return self.km == other_distance.km
        return self.km == other_distance

    def __lt__(self, other_distance: float | Distance) -> bool:
        if isinstance(other_distance, Distance):
            return self.km < other_distance.km
        return self.km < other_distance

    def __le__(self, other_distance: float | Distance) -> bool:
        return not self > other_distance

    def __gt__(self, other_distance: float | Distance) -> bool:
        if isinstance(other_distance, Distance):
            return self.km > other_distance.km
        return self.km > other_distance

    def __ge__(self, other_distance: float | Distance) -> bool:
