...
class Distance:
    ...
    @staticmethod
    def other_type_check(other: Any[Distance, float, int]) -> bool:
    ...
    def __iadd__(self, other: Any[Distance, int, float]) -> Distance:
    ...
    def __truediv__(self, other: Any[float, int]) -> Distance:
        if not self.other_type_check(other):
