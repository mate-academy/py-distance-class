...
class Distance:
    ...
    def __add__(self, distance2: Union[int, float, "Distance"])\
            -> "Distance":
    ...
    def __iadd__(self, distance2: Union[int, float, "Distance"])\
            -> "Distance":
        if isinstance(distance2, Distance):
    ...
    def __truediv__(self, factor: Union[int, float]) -> \
            "Distance":
        if (isinstance(factor, (float, int)) and
                factor != 0):
            result_km = round(self.km / factor, 2)
            return Distance(result_km)

    def __lt__(self, distance2: Union[int, float, "Distance"])\
            -> bool:
        other_km = distance2.km \
            if isinstance(distance2, Distance) else distance2
        return self.km < other_km

    def __gt__(self, distance2: Union[int, float, "Distance"])\
            -> bool:
        other_km = distance2.km \
            if isinstance(distance2, Distance) else distance2
        return self.km > other_km

    def __eq__(self, distance2: Union[int, float, "Distance"])\
            -> bool:
        other_km = distance2.km \
            if isinstance(distance2, Distance) else distance2
        return self.km == other_km

    def __le__(self, distance2: Union[int, float, "Distance"])\
            -> bool:
        other_km = distance2.km \
            if isinstance(distance2, Distance) else distance2
        return self.km <= other_km

    def __ge__(self, distance2: Union[int, float, "Distance"])\
            -> bool:
        other_km = distance2.km \
            if isinstance(distance2, Distance) else distance2
        return self.km >= other_km
