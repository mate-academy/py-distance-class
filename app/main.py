...
class Distance:
    ...
    def __add__(self, other: int or float) -> Union[Distance, int, float]:
    ...
    def __iadd__(self, other: int or float) -> Union[Distance, int, float]:
        if type(other) == Distance:
            self.km += other.km
            return self
        self.km += other
    ...
    def __mul__(self, other: int or float) -> Union[Distance, int, float]:
        return Distance(
            self.km * other
        )
