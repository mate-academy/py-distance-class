...
class Distance:
    ...
    def __add__(self, other: Union[float, int, str]) -> "Distance":
        if isinstance(other, Distance):
            return Distance(self.km + other.km)
        return Distance(self.km + other)

    def __iadd__(self, other: Union[float, int, str]) -> "Distance":
        if isinstance(other, Distance):
            self.km += other.km
    ...
    def __le__(self, other: Union[float, int, str]) -> bool:
        if isinstance(other, Distance):
            return self.km <= other.km
        return self.km <= other

    def __ge__(self, other: Union[float, int, str]) -> bool:
        if isinstance(other, Distance):
            return self.km >= other.km
        return self.km >= other
