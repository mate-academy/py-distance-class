...
class Distance:
    ...
    def __lt__(self, other: Union["Distance", float, int]) -> "Distance":
        if isinstance(other, Distance):
            return self.km < other.km
        return self.km < other

    def __gt__(self, other: Union["Distance", float, int]) -> "Distance":
        if isinstance(other, Distance):
            return self.km > other.km
        return self.km > other

    def __eq__(self, other: Union["Distance", float, int]) -> "Distance":
        if isinstance(other, Distance):
            return self.km == other.km
        return self.km == other
